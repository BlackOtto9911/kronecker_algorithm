...
def kronecker_factorization_ver_6(polynomial):
    global count_lagrange
    count_lagrange = 0
        ...
        for comb in combs:
            ...
            for signs in signs_combs:
                ...
                if is_polynomial(p):
                    ...
                    w=[1]
                    for factor in factorization: w = multiply_polynomials(w, factor)
                    if w == polynomial:
                        end = True
                        break
    ...
    for factor in factorization:
        polynomial, q = divide_polynomials(polynomial, factor)
        polynomial = [round(pp) for pp in polynomial]
